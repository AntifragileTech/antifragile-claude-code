...
> Adds Skill Auto-Discovery, file creation timestamps, response timestamps, agent swarm monitoring, session NOTES.md, and auto continuation prompts to your global CLAUDE.md.
