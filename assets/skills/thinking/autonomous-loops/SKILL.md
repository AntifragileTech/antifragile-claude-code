...
curl -fsSL -o /tmp/install-continuous-claude.sh https://raw.githubusercontent.com/AnandChowdhary/continuous-claude/HEAD/install.sh
less /tmp/install-continuous-claude.sh  # Review first
bash /tmp/install-continuous-claude.sh
```
